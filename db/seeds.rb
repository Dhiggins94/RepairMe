...
@nintendoSwitch = Electronic.create!( name:"nintendo switch" , description:"The Nintendo Switch is a hybrid video game console, consisting of a console unit, a dock, and two Joy-Con controllers.", imageUrl: "https://i.imgur.com/7dpAuXC.jpg")

@repair = RepairGuide.create!(
